...
const orderSchema = new mongoose.Schema(
    {
        ...
        createdAt: { type: Date, get: (date: { toLocaleDateString: () => any; }) => date.toLocaleDateString() },
        updatedAt: { type: Date, get: (date: { toLocaleDateString: () => any; }) => date.toLocaleDateString() },
    },
    {
        toJSON: { getters: true },
        timestamps: true,
